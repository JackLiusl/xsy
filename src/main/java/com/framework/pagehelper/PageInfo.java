package com.framework.pagehelper;
...
public class PageInfo<T> {
	...
	public String toString() {
		...
		jsonObject.put("firstPage", firstPage);
		jsonObject.put("prePage", prePage);
		jsonObject.put("nextPage", nextPage);
		jsonObject.put("lastPage", lastPage);
		jsonObject.put("isFirstPage", isFirstPage);
		jsonObject.put("isLastPage", isLastPage);
		jsonObject.put("hasPreviousPage", hasPreviousPage);
		jsonObject.put("hasNextPage", hasNextPage);
		jsonObject.put("navigatePages", navigatePages);
